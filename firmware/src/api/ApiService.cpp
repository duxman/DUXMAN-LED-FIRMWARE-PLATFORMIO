...
String ApiService::buildOpenApiJson() const {
  ...
  JsonObject schemas = doc["components"]["schemas"].to<JsonObject>();

  JsonObject state = schemas["State"].to<JsonObject>();
  state["type"] = "object";
  JsonObject stateProperties = state["properties"].to<JsonObject>();
  stateProperties["power"]["type"] = "boolean";
  stateProperties["brightness"]["type"] = "integer";
  stateProperties["brightness"]["minimum"] = 0;
  stateProperties["brightness"]["maximum"] = 255;
  stateProperties["effectId"]["type"] = "integer";
  stateProperties["effect"]["type"] = "string";
  stateProperties["effectSpeed"]["type"] = "integer";
  stateProperties["effectSpeed"]["minimum"] = 1;
  stateProperties["effectSpeed"]["maximum"] = 100;
  stateProperties["effectLevel"]["type"] = "integer";
  stateProperties["effectLevel"]["minimum"] = 1;
  stateProperties["effectLevel"]["maximum"] = 10;
  stateProperties["sectionCount"]["type"] = "integer";
  stateProperties["sectionCount"]["minimum"] = 1;
  stateProperties["sectionCount"]["maximum"] = 10;
  stateProperties["effectTransitionMs"]["type"] = "integer";
  stateProperties["effectTransitionMs"]["minimum"] = 0;
  stateProperties["effectTransitionMs"]["maximum"] = 1500;
  stateProperties["effectTransitionStyle"]["type"] = "string";
  stateProperties["effectTransitionStyle"]["enum"][0] = "fade";
  stateProperties["effectTransitionStyle"]["enum"][1] = "wipe";
  stateProperties["paletteId"]["type"] = "integer";
  stateProperties["palette"]["type"] = "string";
  stateProperties["primaryColors"]["type"] = "array";
  stateProperties["primaryColors"]["minItems"] = 3;
  stateProperties["primaryColors"]["maxItems"] = 3;
  stateProperties["primaryColors"]["items"]["type"] = "string";
  stateProperties["backgroundColor"]["type"] = "string";
  ...
  errorResponse["properties"]["error"]["enum"][2] = "invalid_parameter";
  errorResponse["properties"]["error"]["enum"][3] = "invalid_wifi_mode";
  errorResponse["properties"]["error"]["enum"][4] = "invalid_ap_availability";
  errorResponse["properties"]["error"]["enum"][5] = "invalid_ap_ip_mode";
  errorResponse["properties"]["error"]["enum"][6] = "invalid_sta_ip_mode";
  errorResponse["properties"]["error"]["enum"][7] = "invalid_ap_static_ip";
  errorResponse["properties"]["error"]["enum"][8] = "invalid_sta_static_ip";
  errorResponse["properties"]["error"]["enum"][9] = "invalid_sta_primary_dns";
  errorResponse["properties"]["error"]["enum"][10] = "invalid_sta_secondary_dns";
  errorResponse["properties"]["error"]["enum"][11] = "invalid_dns_hostname";
  errorResponse["properties"]["error"]["enum"][12] = "invalid_ntp_server";
  errorResponse["properties"]["error"]["enum"][13] = "invalid_microphone_source";
  errorResponse["properties"]["error"]["enum"][14] = "invalid_microphone_profile_id";
  errorResponse["properties"]["error"]["enum"][15] = "invalid_microphone_sample_rate";
  errorResponse["properties"]["error"]["enum"][16] = "invalid_microphone_fft_size";
  errorResponse["properties"]["error"]["enum"][17] = "invalid_microphone_gain";
  errorResponse["properties"]["error"]["enum"][18] = "invalid_microphone_pin_range";
  errorResponse["properties"]["error"]["enum"][19] = "duplicate_microphone_pins";
  errorResponse["properties"]["error"]["enum"][20] = "missing_microphone_pins";
  errorResponse["properties"]["error"]["enum"][21] = "invalid_language_code";
  errorResponse["properties"]["error"]["enum"][22] = "invalid_general_heartbeat_ms";
  errorResponse["properties"]["error"]["enum"][23] = "too_many_outputs";
  errorResponse["properties"]["error"]["enum"][24] = "invalid_power_max_total_current_ma";
  errorResponse["properties"]["error"]["enum"][25] = "invalid_power_milliamps_per_led_base";
  errorResponse["properties"]["error"]["enum"][26] = "invalid_power_supply_voltage_nominal";
  errorResponse["properties"]["error"]["enum"][27] = "invalid_power_min_acceptable_voltage";
  errorResponse["properties"]["error"]["enum"][28] = "invalid_power_cable_resistance";
  errorResponse["properties"]["error"]["enum"][29] = "power_min_voltage_exceeds_nominal";
  errorResponse["properties"]["error"]["enum"][30] = "power_temp_max_must_exceed_start";
  errorResponse["properties"]["error"]["enum"][31] = "invalid_power_priority_mode";
  errorResponse["properties"]["error"]["enum"][32] = "invalid_sync_mode";
  errorResponse["properties"]["error"]["enum"][33] = "invalid_sync_role";
  errorResponse["properties"]["error"]["enum"][34] = "invalid_sync_input_protocol";
  errorResponse["properties"]["error"]["enum"][35] = "invalid_sync_port";
  errorResponse["properties"]["error"]["enum"][36] = "invalid_sync_e131_universe_start";
  errorResponse["properties"]["error"]["enum"][37] = "invalid_sync_e131_universe_count";
  errorResponse["properties"]["error"]["enum"][38] = "invalid_sync_group_mask";
  errorResponse["properties"]["error"]["enum"][39] = "invalid_sync_source_timeout_ms";
  errorResponse["properties"]["error"]["enum"][40] = "invalid_sync_clock_smoothing";
  errorResponse["properties"]["error"]["enum"][41] = "missing_mode";

  JsonObject networkSchema = schemas["NetworkConfig"].to<JsonObject>();
  networkSchema["type"] = "object";
  JsonObject network = networkSchema["properties"]["network"].to<JsonObject>();
  network["type"] = "object";
  JsonObject networkProperties = network["properties"].to<JsonObject>();
  networkProperties["wifi"]["type"] = "object";
  networkProperties["wifi"]["properties"]["mode"]["type"] = "string";
  networkProperties["wifi"]["properties"]["mode"]["enum"][0] = "ap";
  networkProperties["wifi"]["properties"]["mode"]["enum"][1] = "sta";
  networkProperties["wifi"]["properties"]["mode"]["enum"][2] = "ap_sta";
  networkProperties["wifi"]["properties"]["apAvailability"]["type"] = "string";
  networkProperties["wifi"]["properties"]["apAvailability"]["enum"][0] = "always";
  networkProperties["wifi"]["properties"]["apAvailability"]["enum"][1] = "untilStaConnected";
  networkProperties["wifi"]["properties"]["connection"]["type"] = "object";
  networkProperties["wifi"]["properties"]["connection"]["properties"]["ssid"]["type"] = "string";
  networkProperties["wifi"]["properties"]["connection"]["properties"]["password"]["type"] = "string";
  networkProperties["ip"]["type"] = "object";
  networkProperties["ip"]["properties"]["ap"]["$ref"] = "#/components/schemas/NetworkIpConfig";
  networkProperties["ip"]["properties"]["sta"]["$ref"] = "#/components/schemas/NetworkStaConfig";
  networkProperties["dns"]["type"] = "object";
  networkProperties["dns"]["properties"]["hostname"]["type"] = "string";
  networkProperties["dns"]["properties"]["hostname"]["maxLength"] = 63;
  networkProperties["time"]["type"] = "object";
  networkProperties["time"]["properties"]["syncOnBoot"]["type"] = "boolean";
  networkProperties["time"]["properties"]["ntpServer"]["type"] = "string";
  networkProperties["time"]["properties"]["ntpServer"]["maxLength"] = 128;

  JsonObject networkIpSchema = schemas["NetworkIpConfig"].to<JsonObject>();
  networkIpSchema["type"] = "object";
  networkIpSchema["properties"]["mode"]["type"] = "string";
  networkIpSchema["properties"]["mode"]["enum"][0] = "dhcp";
  networkIpSchema["properties"]["mode"]["enum"][1] = "static";
  networkIpSchema["properties"]["address"]["type"] = "string";
  networkIpSchema["properties"]["gateway"]["type"] = "string";
  networkIpSchema["properties"]["subnet"]["type"] = "string";

  JsonObject networkStaSchema = schemas["NetworkStaConfig"].to<JsonObject>();
  networkStaSchema["allOf"][0]["$ref"] = "#/components/schemas/NetworkIpConfig";
  networkStaSchema["properties"]["primaryDns"]["type"] = "string";
  networkStaSchema["properties"]["secondaryDns"]["type"] = "string";

  JsonObject networkResponse = schemas["NetworkResponse"].to<JsonObject>();
  networkResponse["type"] = "object";
  networkResponse["properties"]["updated"]["type"] = "boolean";
  networkResponse["properties"]["network"]["$ref"] = "#/components/schemas/NetworkConfig";

  JsonObject microphoneSchema = schemas["MicrophoneConfig"].to<JsonObject>();
  microphoneSchema["type"] = "object";
  JsonObject microphone = microphoneSchema["properties"]["microphone"].to<JsonObject>();
  microphone["type"] = "object";
  microphone["properties"]["enabled"]["type"] = "boolean";
  microphone["properties"]["source"]["type"] = "string";
  microphone["properties"]["source"]["enum"][0] = "generic_i2c";
  microphone["properties"]["source"]["enum"][1] = "i2s";
  microphone["properties"]["profileId"]["type"] = "string";
  microphone["properties"]["profileId"]["enum"][0] = "DEFAULT";
  microphone["properties"]["profileId"]["enum"][1] = "gledopto_gl_c_017wl_d";
  microphone["properties"]["sampleRate"]["type"] = "integer";
  microphone["properties"]["sampleRate"]["minimum"] = 8000;
  microphone["properties"]["sampleRate"]["maximum"] = 48000;
  microphone["properties"]["fftSize"]["type"] = "integer";
  microphone["properties"]["fftSize"]["enum"][0] = 256;
  microphone["properties"]["fftSize"]["enum"][1] = 512;
  microphone["properties"]["fftSize"]["enum"][2] = 1024;
  microphone["properties"]["fftSize"]["enum"][3] = 2048;
  microphone["properties"]["gainPercent"]["type"] = "integer";
  microphone["properties"]["gainPercent"]["minimum"] = 1;
  microphone["properties"]["gainPercent"]["maximum"] = 200;
  microphone["properties"]["noiseFloorPercent"]["type"] = "integer";
  microphone["properties"]["noiseFloorPercent"]["minimum"] = 0;
  microphone["properties"]["noiseFloorPercent"]["maximum"] = 100;
  microphone["properties"]["noiseGateKnee"]["type"] = "integer";
  microphone["properties"]["noiseGateKnee"]["minimum"] = 0;
  microphone["properties"]["noiseGateKnee"]["maximum"] = 200;
  microphone["properties"]["agcResponsePercent"]["type"] = "integer";
  microphone["properties"]["agcResponsePercent"]["minimum"] = 10;
  microphone["properties"]["agcResponsePercent"]["maximum"] = 200;
  microphone["properties"]["pins"]["type"] = "object";
  microphone["properties"]["pins"]["properties"]["bclk"]["type"] = "integer";
  microphone["properties"]["pins"]["properties"]["ws"]["type"] = "integer";
  microphone["properties"]["pins"]["properties"]["din"]["type"] = "integer";

  JsonObject microphoneResponse = schemas["MicrophoneResponse"].to<JsonObject>();
  microphoneResponse["type"] = "object";
  microphoneResponse["properties"]["updated"]["type"] = "boolean";
  microphoneResponse["properties"]["microphone"]["$ref"] = "#/components/schemas/MicrophoneConfig";

  JsonObject generalSchema = schemas["GeneralConfig"].to<JsonObject>();
  generalSchema["type"] = "object";
  JsonObject general = generalSchema["properties"]["general"].to<JsonObject>();
  general["type"] = "object";
  general["properties"]["language"]["type"] = "string";
  general["properties"]["language"]["enum"][0] = "en";
  general["properties"]["language"]["enum"][1] = "es";
  general["properties"]["language"]["enum"][2] = "fr";
  general["properties"]["language"]["enum"][3] = "de";
  general["properties"]["language"]["enum"][4] = "it";
  general["properties"]["regionCode"]["type"] = "string";
  general["properties"]["debugEnabled"]["type"] = "boolean";
  general["properties"]["heartbeatMs"]["type"] = "integer";
  general["properties"]["heartbeatMs"]["minimum"] = 0;
  general["properties"]["heartbeatMs"]["maximum"] = 600000;

  JsonObject generalResponse = schemas["GeneralResponse"].to<JsonObject>();
  generalResponse["type"] = "object";
  generalResponse["properties"]["updated"]["type"] = "boolean";
  generalResponse["properties"]["general"]["$ref"] = "#/components/schemas/GeneralConfig";

  JsonObject gpioSchema = schemas["GpioConfig"].to<JsonObject>();
  gpioSchema["type"] = "object";
  JsonObject gpio = gpioSchema["properties"]["gpio"].to<JsonObject>();
  gpio["type"] = "object";
  gpio["properties"]["outputs"]["type"] = "array";
  gpio["properties"]["outputs"]["maxItems"] = 4;
  JsonObject output = gpio["properties"]["outputs"]["items"].to<JsonObject>();
  output["type"] = "object";
  output["properties"]["id"]["type"] = "integer";
  output["properties"]["pin"]["type"] = "integer";
  output["properties"]["pin"]["minimum"] = -1;
  output["properties"]["pin"]["maximum"] = 48;
  output["properties"]["ledCount"]["type"] = "integer";
  output["properties"]["ledCount"]["minimum"] = 1;
  output["properties"]["ledCount"]["maximum"] = 1500;
  output["properties"]["ledType"]["type"] = "string";
  output["properties"]["ledType"]["enum"][0] = "digital";
  output["properties"]["ledType"]["enum"][1] = "ws2812b";
  output["properties"]["ledType"]["enum"][2] = "ws2811";
  output["properties"]["ledType"]["enum"][3] = "ws2813";
  output["properties"]["ledType"]["enum"][4] = "ws2815";
  output["properties"]["ledType"]["enum"][5] = "sk6812";
  output["properties"]["ledType"]["enum"][6] = "tm1814";
  output["properties"]["colorOrder"]["type"] = "string";
  output["properties"]["colorOrder"]["enum"][0] = "R";
  output["properties"]["colorOrder"]["enum"][1] = "G";
  output["properties"]["colorOrder"]["enum"][2] = "B";
  output["properties"]["colorOrder"]["enum"][3] = "W";
  output["properties"]["colorOrder"]["enum"][4] = "RGB";
  output["properties"]["colorOrder"]["enum"][5] = "GRB";
  output["properties"]["colorOrder"]["enum"][6] = "BRG";
  output["properties"]["colorOrder"]["enum"][7] = "RBG";
  output["properties"]["colorOrder"]["enum"][8] = "GBR";
  output["properties"]["colorOrder"]["enum"][9] = "BGR";
  output["properties"]["colorOrder"]["enum"][10] = "RGBW";
  output["properties"]["colorOrder"]["enum"][11] = "GRBW";
  gpio["properties"]["power"]["type"] = "object";
  JsonObject power = gpio["properties"]["power"].as<JsonObject>();
  power["properties"]["powerLimitEnabled"]["type"] = "boolean";
  power["properties"]["maxTotalCurrentmA"]["type"] = "integer";
  power["properties"]["maxTotalCurrentmA"]["minimum"] = 200;
  power["properties"]["maxTotalCurrentmA"]["maximum"] = 50000;
  power["properties"]["milliAmpsPerLedBase"]["type"] = "integer";
  power["properties"]["milliAmpsPerLedBase"]["minimum"] = 5;
  power["properties"]["milliAmpsPerLedBase"]["maximum"] = 80;
  power["properties"]["voltageSagCorrectionEnabled"]["type"] = "boolean";
  power["properties"]["cableResistanceOhms"]["type"] = "number";
  power["properties"]["cableResistanceOhms"]["minimum"] = 0;
  power["properties"]["cableResistanceOhms"]["maximum"] = 1;
  power["properties"]["supplyVoltageNominal"]["type"] = "number";
  power["properties"]["supplyVoltageNominal"]["minimum"] = 3;
  power["properties"]["supplyVoltageNominal"]["maximum"] = 48;
  power["properties"]["minAcceptableVoltage"]["type"] = "number";
  power["properties"]["minAcceptableVoltage"]["minimum"] = 1;
  power["properties"]["minAcceptableVoltage"]["maximum"] = 48;
  power["properties"]["thermalThrottlingEnabled"]["type"] = "boolean";
  power["properties"]["temperatureSensorPin"]["type"] = "integer";
  power["properties"]["temperatureSensorPin"]["minimum"] = -1;
  power["properties"]["temperatureSensorPin"]["maximum"] = 48;
  power["properties"]["tempThrottleStartC"]["type"] = "integer";
  power["properties"]["tempThrottleStartC"]["minimum"] = -20;
  power["properties"]["tempThrottleStartC"]["maximum"] = 100;
  power["properties"]["tempThrottleMaxC"]["type"] = "integer";
  power["properties"]["tempThrottleMaxC"]["minimum"] = 0;
  power["properties"]["tempThrottleMaxC"]["maximum"] = 120;
  power["properties"]["smartDimmingEnabled"]["type"] = "boolean";
  power["properties"]["preserveBlueFrequency"]["type"] = "boolean";
  power["properties"]["priorityMode"]["type"] = "integer";
  power["properties"]["priorityMode"]["minimum"] = 0;
  power["properties"]["priorityMode"]["maximum"] = 2;

  JsonObject gpioResponse = schemas["GpioResponse"].to<JsonObject>();
  gpioResponse["type"] = "object";
  gpioResponse["properties"]["updated"]["type"] = "boolean";
  gpioResponse["properties"]["gpio"]["$ref"] = "#/components/schemas/GpioConfig";

  JsonObject syncSchema = schemas["SyncConfig"].to<JsonObject>();
  syncSchema["type"] = "object";
  JsonObject sync = syncSchema["properties"]["sync"].to<JsonObject>();
  sync["type"] = "object";
  sync["properties"]["enabled"]["type"] = "boolean";
  sync["properties"]["mode"]["type"] = "string";
  sync["properties"]["mode"]["enum"][0] = "off";
  sync["properties"]["mode"]["enum"][1] = "local_effects";
  sync["properties"]["mode"]["enum"][2] = "ledfx_realtime";
  sync["properties"]["mode"]["enum"][3] = "cluster_sync";
  sync["properties"]["role"]["type"] = "string";
  sync["properties"]["role"]["enum"][0] = "client";
  sync["properties"]["role"]["enum"][1] = "server";
  sync["properties"]["inputProtocol"]["type"] = "string";
  sync["properties"]["inputProtocol"]["enum"][0] = "ddp";
  sync["properties"]["inputProtocol"]["enum"][1] = "e131";
  sync["properties"]["ddpPort"]["type"] = "integer";
  sync["properties"]["ddpPort"]["minimum"] = 1;
  sync["properties"]["ddpPort"]["maximum"] = 65535;
  sync["properties"]["e131UniverseStart"]["type"] = "integer";
  sync["properties"]["e131UniverseStart"]["minimum"] = 1;
  sync["properties"]["e131UniverseStart"]["maximum"] = 63999;
  sync["properties"]["e131UniverseCount"]["type"] = "integer";
  sync["properties"]["e131UniverseCount"]["minimum"] = 1;
  sync["properties"]["e131UniverseCount"]["maximum"] = 9;
  sync["properties"]["udpSyncPort"]["type"] = "integer";
  sync["properties"]["udpSyncPort"]["minimum"] = 1;
  sync["properties"]["udpSyncPort"]["maximum"] = 65535;
  sync["properties"]["groupMask"]["type"] = "integer";
  sync["properties"]["groupMask"]["minimum"] = 1;
  sync["properties"]["groupMask"]["maximum"] = 255;
  sync["properties"]["sourceTimeoutMs"]["type"] = "integer";
  sync["properties"]["sourceTimeoutMs"]["minimum"] = 100;
  sync["properties"]["sourceTimeoutMs"]["maximum"] = 60000;
  sync["properties"]["clockSmoothing"]["type"] = "string";
  sync["properties"]["clockSmoothing"]["enum"][0] = "off";
  sync["properties"]["clockSmoothing"]["enum"][1] = "soft";

  JsonObject syncResponse = schemas["SyncConfigResponse"].to<JsonObject>();
  syncResponse["type"] = "object";
  syncResponse["properties"]["updated"]["type"] = "boolean";
  syncResponse["properties"]["state"]["type"] = "object";

  JsonObject syncModeRequest = schemas["SyncModeRequest"].to<JsonObject>();
  syncModeRequest["type"] = "object";
  syncModeRequest["properties"]["mode"]["type"] = "string";
  syncModeRequest["properties"]["mode"]["enum"][0] = "off";
  syncModeRequest["properties"]["mode"]["enum"][1] = "local_effects";
  syncModeRequest["properties"]["mode"]["enum"][2] = "ledfx_realtime";
  syncModeRequest["properties"]["mode"]["enum"][3] = "cluster_sync";

  JsonObject syncModeResponse = schemas["SyncModeResponse"].to<JsonObject>();
  syncModeResponse["type"] = "object";
  syncModeResponse["properties"]["updated"]["type"] = "boolean";
  syncModeResponse["properties"]["mode"]["type"] = "string";
  ...
  statePath["get"]["responses"]["200"]["description"] = "Estado actual";
  statePath["get"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/State";
  statePath["patch"]["summary"] = "Actualizar estado con JSON parcial";
  statePath["patch"]["requestBody"]["required"] = true;
  statePath["patch"]["requestBody"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/StatePatch";
  statePath["patch"]["responses"]["200"]["description"] = "Estado aplicado o sin cambios";
  statePath["patch"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/StateResponse";
  statePath["patch"]["responses"]["400"]["description"] = "Payload invalido";
  statePath["patch"]["responses"]["400"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/ErrorResponse";
  statePath["post"]["summary"] = "Alias de PATCH para clientes limitados";
  statePath["post"]["requestBody"] = statePath["patch"]["requestBody"];
  statePath["post"]["responses"] = statePath["patch"]["responses"];

  JsonObject netPath = paths["/api/v1/config/network"].to<JsonObject>();
  netPath["get"]["summary"] = "Obtener configuracion de red";
  netPath["get"]["responses"]["200"]["description"] = "Configuracion de red actual";
  netPath["get"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/NetworkConfig";
  netPath["patch"]["summary"] = "Actualizar configuracion de red, DNS STA y NTP con JSON parcial";
  netPath["patch"]["requestBody"]["required"] = true;
  netPath["patch"]["requestBody"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/NetworkConfig";
  netPath["patch"]["responses"]["200"]["description"] = "Configuracion aplicada o sin cambios";
  netPath["patch"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/NetworkResponse";
  netPath["patch"]["responses"]["400"]["description"] = "Payload o configuracion invalida";
  netPath["patch"]["responses"]["400"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/ErrorResponse";
  netPath["post"]["summary"] = "Alias de PATCH para clientes limitados";
  netPath["post"]["requestBody"] = netPath["patch"]["requestBody"];
  netPath["post"]["responses"] = netPath["patch"]["responses"];
  ...
  micPath["get"]["responses"]["200"]["description"] = "Configuracion de microfono actual";
  micPath["get"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/MicrophoneConfig";
  micPath["patch"]["summary"] = "Actualizar configuracion de microfono con JSON parcial";
  micPath["patch"]["requestBody"]["required"] = true;
  micPath["patch"]["requestBody"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/MicrophoneConfig";
  micPath["patch"]["responses"]["200"]["description"] = "Configuracion aplicada o sin cambios";
  micPath["patch"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/MicrophoneResponse";
  micPath["patch"]["responses"]["400"]["description"] = "Payload o configuracion invalida";
  micPath["patch"]["responses"]["400"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/ErrorResponse";
  micPath["post"]["summary"] = "Alias de PATCH para clientes limitados";
  micPath["post"]["requestBody"] = micPath["patch"]["requestBody"];
  micPath["post"]["responses"] = micPath["patch"]["responses"];
  ...
  JsonObject generalPath = paths["/api/v1/config/general"].to<JsonObject>();
  generalPath["get"]["summary"] = "Obtener configuracion general";
  generalPath["get"]["responses"]["200"]["description"] = "Configuracion general actual";
  generalPath["get"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/GeneralConfig";
  generalPath["patch"]["summary"] = "Actualizar configuracion general con JSON parcial";
  generalPath["patch"]["requestBody"]["required"] = true;
  generalPath["patch"]["requestBody"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/GeneralConfig";
  generalPath["patch"]["responses"]["200"]["description"] = "Configuracion aplicada o sin cambios";
  generalPath["patch"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/GeneralResponse";
  generalPath["patch"]["responses"]["400"]["description"] = "Payload o configuracion invalida";
  generalPath["patch"]["responses"]["400"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/ErrorResponse";
  generalPath["post"]["summary"] = "Alias de PATCH para clientes limitados";
  generalPath["post"]["requestBody"] = generalPath["patch"]["requestBody"];
  generalPath["post"]["responses"] = generalPath["patch"]["responses"];

  JsonObject gpioPath = paths["/api/v1/config/gpio"].to<JsonObject>();
  gpioPath["get"]["summary"] = "Obtener configuracion GPIO";
  gpioPath["get"]["responses"]["200"]["description"] = "Configuracion GPIO actual";
  gpioPath["get"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/GpioConfig";
  gpioPath["patch"]["summary"] = "Actualizar GPIO (outputs + powerLimit: enabled, maxCurrentmA, milliAmpsPerLed)";
  gpioPath["patch"]["requestBody"]["required"] = true;
  gpioPath["patch"]["requestBody"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/GpioConfig";
  gpioPath["patch"]["responses"]["200"]["description"] = "Configuracion aplicada o sin cambios";
  gpioPath["patch"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/GpioResponse";
  gpioPath["patch"]["responses"]["400"]["description"] = "Payload o configuracion invalida";
  gpioPath["patch"]["responses"]["400"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/ErrorResponse";
  gpioPath["post"]["summary"] = "Alias de PATCH para clientes limitados";
  gpioPath["post"]["requestBody"] = gpioPath["patch"]["requestBody"];
  gpioPath["post"]["responses"] = gpioPath["patch"]["responses"];
  ...
  syncConfigPath["get"]["responses"]["200"]["description"] = "Configuracion de sincronizacion actual";
  syncConfigPath["get"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/SyncConfig";
  syncConfigPath["patch"]["summary"] = "Actualizar configuracion de sincronizacion con JSON parcial";
  syncConfigPath["patch"]["requestBody"]["required"] = true;
  syncConfigPath["patch"]["requestBody"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/SyncConfig";
  syncConfigPath["patch"]["responses"]["200"]["description"] = "Configuracion aplicada o sin cambios";
  syncConfigPath["patch"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/SyncConfigResponse";
  syncConfigPath["patch"]["responses"]["400"]["description"] = "Payload o configuracion invalida";
  syncConfigPath["patch"]["responses"]["400"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/ErrorResponse";
  syncConfigPath["post"]["summary"] = "Alias de PATCH para clientes limitados";
  syncConfigPath["post"]["requestBody"] = syncConfigPath["patch"]["requestBody"];
  syncConfigPath["post"]["responses"] = syncConfigPath["patch"]["responses"];

  JsonObject syncModePath = paths["/api/v1/sync/mode"].to<JsonObject>();
  syncModePath["patch"]["summary"] = "Cambiar modo de sincronizacion";
  syncModePath["patch"]["requestBody"]["required"] = true;
  syncModePath["patch"]["requestBody"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/SyncModeRequest";
  syncModePath["patch"]["responses"]["200"]["description"] = "Modo aplicado o sin cambios";
  syncModePath["patch"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/SyncModeResponse";
  syncModePath["patch"]["responses"]["400"]["description"] = "Modo ausente o invalido";
  syncModePath["patch"]["responses"]["400"]["content"]["application/json"]["schema"]["$ref"] = "#/components/schemas/ErrorResponse";
